...
::accordion
  ...
  - **Terminator:** A feature-rich terminal emulator with split-screen capabilities :badge[Linux]{color="gray" variant="soft"}.
  - **Guake:** A drop-down terminal for quick access :badge[Linux]{color="gray" variant="soft"}.
  :::
  ...
  - **Email Client:** Mailspring :badge[Linux]{color="gray" variant="soft"}
  - **Productivity:** TickTick :badge[macOS], RescueTime :badge[Linux]{color="gray" variant="soft"}
  :::

  :::item{label="Multimedia & Graphics" icon="i-heroicons-photo"}
  - **Media Player:** VLC
  - **Screenshot Tool:** Flameshot :badge[Linux]{color="gray" variant="soft"}, Shottr :badge[macOS]
  ...
  - **Terminal Emulators:** iTerm2 :badge[macOS], Guake :badge[Linux]{color="gray" variant="soft"}, Terminator :badge[Linux]{color="gray" variant="soft"}
  - **Window Manager:** i3 :badge[Linux]{color="gray" variant="soft"}
  - **Fonts:** Hack Nerd Font, Fira Code, Roboto
  - **VPN:** AdGuard VPN :badge[macOS], OpenConnect :badge[Linux]{color="gray" variant="soft"}
  :::
::
