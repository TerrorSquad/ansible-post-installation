---
title: Contributing
description: Guidelines for contributing to Griffin
navigation:
...
Please note that this project adheres to a [Code of Conduct](/support/code_of_conduct). By participating, you are expected to uphold this code.
